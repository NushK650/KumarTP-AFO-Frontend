...
async function getComputerChoice(UserInput) {
    try {
      const response = await fetch(`https://kumartc-allforone-byf7akcedfckc0dh.westus-01.azurewebsites.net/ReverseItNO/ReverseItNO/${UserInput}`); // Replace this URL with your actual API endpoint
